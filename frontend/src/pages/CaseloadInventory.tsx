  ...
  return (
    <div className={`caseload-inventory${embedded ? ' caseload-inventory--embedded' : ''}`}>
      ...
      <div className="risk-info-note">
        ...
        the likelihood of regression or adverse outcomes. Tiers: Critical, High, Moderate, Low. Here are some of the 
        most influential factors that contribute to the risk score:
        <ul>
          <li><strong>General health score</strong> — the strongest single predictor of resident trajectory</li>
          <li><strong>Nutrition score and BMI</strong> — physical wellbeing indicators closely tied to risk level</li>
          <li><strong>Checkup completion</strong> — whether medical, dental, and psychological checkups are being completed consistently</li>
          <li><strong>Sleep quality</strong> — a meaningful early indicator of underlying distress</li>
          <li><strong>Incident resolution rate</strong> — how consistently open incidents are followed through to resolution</li>
          <li><strong>Counseling session duration</strong> — consistency and depth of counseling engagement</li>
          <li><strong>Family background</strong> — informal settler status is associated with elevated risk</li>
          <li><strong>Length of stay</strong> — residents newer to the program have less history for the model to draw from, so their scores should be interpreted with that in mind</li>
        </ul>
      </div>
