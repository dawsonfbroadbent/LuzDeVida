    ...
    <div className={`caseload-inventory${embedded ? ' caseload-inventory--embedded' : ''}`}>
      ...
      <div className="risk-info-note">
        ...
        most influential factors that contribute to the risk score:
          <p><strong>General health score</strong> — the strongest single predictor of resident trajectory</p>
          <p><strong>Nutrition score and BMI</strong> — physical wellbeing indicators closely tied to risk level</p>
          <p><strong>Checkup completion</strong> — whether medical, dental, and psychological checkups are being completed consistently</p>
          <p><strong>Sleep quality</strong> — a meaningful early indicator of underlying distress</p>
          <p><strong>Incident resolution rate</strong> — how consistently open incidents are followed through to resolution</p>
          <p><strong>Counseling session duration</strong> — consistency and depth of counseling engagement</p>
          <p><strong>Family background</strong> — informal settler status is associated with elevated risk</p>
          <p><strong>Length of stay</strong> — residents newer to the program have less history for the model to draw from, so their scores should be interpreted with that in mind</p>
      </div>
