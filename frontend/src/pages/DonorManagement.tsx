  ...
  return (
    <div className={`donor-management${embedded ? ' donor-management--embedded' : ''}`}>
      ...
      <div className="dm-risk-info-note">
        ...
        <ul>
          <li><strong>Invite donors to support more programs.</strong> Donors who fund multiple program areas are 69% less likely to churn. Share updates about programs a donor hasn't yet supported and make it easy for them to broaden their giving.</li>
          <li><strong>Encourage in-kind contributions.</strong> Donors who have given goods, services, or skills are 61% less likely to churn. When a donor shows signs of going quiet, an in-kind ask can be a more natural re-engagement than requesting money again.</li>
          <li><strong>Leverage event-based giving.</strong> Donors acquired or engaged through events show significantly lower churn rates. Prioritize inviting at-risk donors to upcoming events as a low-pressure way to reconnect with the organization.</li>
          <li><strong>Invest in social media referrals.</strong> Donors who discovered Luz de Vida through social media are substantially more retained. Encourage current donors to share posts and tag others, since socially-referred donors tend to feel a personal connection to the cause.</li>
        </ul>
      </div>
